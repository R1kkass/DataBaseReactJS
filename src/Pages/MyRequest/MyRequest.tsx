...
const response = Api.fetchMyPost(searchParams.get('query') || '', searchParams.get('page') || 1, searchParams.get('sort') || 'DESC', searchParams.get('pole') || 'id',searchParams.get('search') || '', localStorage.getItem('token') || '')
.then((res: any)=>{
count=res?.count
setPost(res.rows)
})
